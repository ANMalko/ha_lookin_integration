up_dev_env:
	docker run -d --name="home-assistant" -v ~/Documents/Projects/MyProject/ha_integration/ha_config:/config -e "TZ=Europe/Moscow" -p 8123:8123 homeassistant/home-assistant
